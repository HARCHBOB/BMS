...
CREATE UNIQUE INDEX idx_unique_parking_beginning ON bms.Parking(Parking_Beginning);
CREATE UNIQUE INDEX idx_unique_parking_ending ON bms.Parking(Parking_Ending);
